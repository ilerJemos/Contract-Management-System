...
public class RegisterServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		/*
		 * Process registration request, verify the following:
		 * 1.user name, password, and the repeat password can not be empty.
		 * 2.Repeat password and password should keep consistent.
		 * 
